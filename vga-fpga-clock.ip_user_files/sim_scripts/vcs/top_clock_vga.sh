...
#
# Script generated by Vivado on Sun Apr 26 20:15:33 CST 2026
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_clock_vga.sh
...
#
# Usage        : top_clock_vga.sh
#                top_clock_vga.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_clock_vga.sh [-reset_run]
#                top_clock_vga.sh [-reset_log]
#                top_clock_vga.sh [-help]
#
...
#                script (type 'top_clock_vga.sh -help' for more information).
#
...
# script info
echo -e "top_clock_vga.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_clock_vga.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../project_Controlador\\ VGA\\ con\\ Reloj\\ Digital.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.top_clock_vga xil_defaultlib.glbl -o top_clock_vga_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./top_clock_vga_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/gabrielqg/vga-digital-clock/project_Controlador"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key top_clock_vga_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc top_clock_vga_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_clock_vga.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_clock_vga.sh [-help]\n\
Usage: top_clock_vga.sh [-step]\n\
Usage: top_clock_vga.sh [-lib_map_path]\n\
Usage: top_clock_vga.sh [-reset_run]\n\
Usage: top_clock_vga.sh [-reset_log]\n\
Usage: top_clock_vga.sh [-keep_index]\n\
Usage: top_clock_vga.sh [-noclean_files]\n\n\
