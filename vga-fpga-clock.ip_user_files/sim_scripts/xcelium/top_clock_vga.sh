...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../project_Controlador VGA con Reloj Digital.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.top_clock_vga xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.top_clock_vga -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log top_clock_vga_sc.so .tmp_log xcelium_lib waves.shm c.obj)
